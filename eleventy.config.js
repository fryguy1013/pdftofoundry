...
module.exports = function(eleventyConfig) {
    ...
    eleventyConfig.addFilter("preamble", (content) => {
    ...
    eleventyConfig.addAsyncShortcode("currentYear", async function currentYear() {
        return new Date().getFullYear();
    });

    eleventyConfig.addFilter("gallery", async function (inputFile) {
        const dir = path.dirname(inputFile);
        const files = await glob(dir + "/*.jpg");
